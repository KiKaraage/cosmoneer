...
UBLUE_IMAGE_TAG="${UBLUE_IMAGE_TAG:-daily}"
...
sed -i "s|^CPE_NAME=\"cpe:/o:fedoraproject:fedora:.*\"|CPE_NAME=\"cpe:/o:universal-blue:${IMAGE_PRETTY_NAME,}:${VERSION_ID}\"|" /usr/lib/os-release
